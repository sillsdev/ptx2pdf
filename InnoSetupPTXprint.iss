...
#define MyAppExeName "PTXprint-0.5.3.exe"
...
OutputBaseFilename=SetupPTXprint(0.5.3-beta)
...
[Files]
Source: "dist\ptxprint\PTXprint-0.5.3.exe"; DestDir: "{app}"; Flags: ignoreversion
