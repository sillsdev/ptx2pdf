...
{document/ifaligndiglot}{project/ifusemodssty}\stylesheet{{{/ptxpath}/{document/diglotsecprj}/PrintDraft/PrintDraft-mods.sty}} % Right-side/Diglot Secondary stylesheet override settings
