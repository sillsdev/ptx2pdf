...
{document/hangpoetry}\sethook{{end}}{{q}}{{\let\printv@rse=\simpleprintv@rse}}
...
{document/hangpoetry}\sethook{{end}}{{q3}}{{\let\printv@rse=\simpleprintv@rse}}
{document/hangpoetry}\sethook{{end}}{{q4}}{{\let\printv@rse=\simpleprintv@rse}}
{document/hangpoetry}\sethook{{end}}{{qm}}{{\let\printv@rse=\simpleprintv@rse}}
{document/hangpoetry}\sethook{{end}}{{qm1}}{{\let\printv@rse=\simpleprintv@rse}}
{document/hangpoetry}\sethook{{end}}{{qm2}}{{\let\printv@rse=\simpleprintv@rse}}
{document/hangpoetry}\sethook{{end}}{{qm3}}{{\let\printv@rse=\simpleprintv@rse}}
