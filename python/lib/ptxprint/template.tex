...
{paper/ifgrid}\CropMarks{paper/ifcropmarks}
...
%% Faces
\def\regular{L_}{{"{document/fontregular}{document/script}"}}
\def\bold{L_}{{"{document/fontbold}{document/script}"}}
\def\italic{L_}{{"{document/fontitalic}{document/script}"}}
\def\bolditalic{L_}{{"{document/fontbolditalic}{document/script}"}}
...
{notes/iffootnoterule}\def\footnoterule{{}} {notes/endnotes_}\def\zendnoterule{{}}
...
{notes/endnotes_}\NoteAtEnd{{f}}\def\AboveEndNoteRule{{{notes/abovenotetotal} pt}}\def\BelowEndNoteRule{{{notes/belownoterulespace} pt}}
