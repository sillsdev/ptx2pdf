...
{project/ifusecustomsty}\stylesheet{L_}{{{/ptxpath}/{project/id}/custom.sty}}

\stylesheet{L_}{{/nststypath}} % PTXprint-generated stylesheet changes (for versenums, ftnts, xref, size + spacing)
{document/ifaligndiglot}\stylesheet{R_}{{/nststypathR}} % generated stylesheet for Secondary project (for versenums, ftnts, xref, size + spacing)
