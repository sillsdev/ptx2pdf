...
% Where to put these kinds of files? 
%\def\PageBorder{{"C:/My Paratext 9 Projects/WSGlatin/PrintDraft/A4-Draft.pdf"}}
%{paper/watermark}\def\PageBorder{{{/ptxpath}/{project/id}/PrintDraft/A4-Draft.pdf}}
{paper/watermark}\def\PageBorder{{"{paper/watermarkpdf}"}}  % and also pretty border PDFs etc.

%\includepdf{{mytitlepage.pdf}}
...
%\includepdf{{myendofbookfile.pdf}}
