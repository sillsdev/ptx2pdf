...
%{document/ifaligndiglot}\stylesheet{R_}{{{/ptxrpath}/{document/diglotsecprj}/usfm.sty}}
%\stylesheet{L_}{{{/ptxrpath}/{project/id}/usfm.sty}}

{document/ifaligndiglot}{project/ifusecustomsty}\stylesheet{R_}{{{/ptxrpath}/{document/diglotsecprj}/custom.sty}}
{project/ifusecustomsty}{/nocustomsty}\stylesheet{L_}{{{/ptxrpath}/{project/id}/custom.sty}}

{document/ifaligndiglot}\stylesheet{R_}{{{/nststypathR}}} % generated stylesheet for Secondary project
\stylesheet{L_}{{{/nststypath}}} % generated stylesheet for monodoc or Primary project

{document/ifaligndiglot}{project/ifusemodssty}\stylesheet{R_}{{{/ptxrpath}/{document/diglotsecprj}/PrintDraft/PrintDraft-mods.sty}} % Right-side/Diglot Secondary stylesheet override settings
{project/ifusemodssty}\stylesheet{L_}{{{/ptxrpath}/{project/id}/PrintDraft/PrintDraft-mods.sty}} % Left-side stylesheet override settings
