...
{notes/xrlocation}\def\XrefNotes{{x}}\def\XrefNotesMargin{{1.5pt}}\XrefNotesWidth={notes/xrcentrecolwidth}pt
\ColNotes{notes/columnnotes}
...
{document/toc}{document/multibook}\GenerateTOC[{document/toctitle}]{{{jobname}.toc}}
{document/toc}{document/multibook}\BodyColumns=1     % Temporarily set this to Single Column for the ToC page(s)
{document/toc}{document/multibook}\ptxfile{{{jobname}.toc}}
{document/toc}{document/multibook}\BodyColumns={paper/columns}     % But ensure it goes back to the chosen Single/Double setting for the main body text
