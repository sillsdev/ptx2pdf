...
{project/ifnotptmacros}{project/blockexperimental}\endbooknoeject{project/ifstarthalfpage}
...
{document/usefigsfolder}\PicPath={{{project/picdir}/}}
...
{project/ifusemodstex}\input "{/ptxpath}/{project/id}/PrintDraft/ptxprint-mods.tex"% adjust/override setup parameters here
