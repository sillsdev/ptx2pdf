...
%% Faces
\def\regular{{"{fontregular}{fontregular/engine}{font/texfeatures}{document/script}{document/digitmapping}"}}
\def\bold{{"{fontbold}{fontbold/engine}{font/texfeatures}{document/script}{document/digitmapping}{fontbold/embolden}{fontbold/slant}"}}
\def\italic{{"{fontitalic}{fontitalic/engine}{font/texfeatures}{document/script}{document/digitmapping}{fontitalic/embolden}{fontitalic/slant}"}}
\def\bolditalic{{"{fontbolditalic}{fontbolditalic/engine}{font/texfeatures}{document/script}{document/digitmapping}{fontbolditalic/embolden}{fontbolditalic/slant}"}}
