...
%{document/ifaligndiglot}\stylesheet{R_}{{{/ptxpath}/{document/diglotsecprj}/usfm.sty}}
%\stylesheet{L_}{{{/ptxpath}/{project/id}/usfm.sty}}

{document/ifaligndiglot}{project/ifusecustomsty}\stylesheet{R_}{{{/ptxpath}/{document/diglotsecprj}/custom.sty}}
{project/ifusecustomsty}{/nocustomsty}\stylesheet{L_}{{{/ptxpath}/{project/id}/custom.sty}}
...
{document/ifaligndiglot}{project/ifusemodssty}\stylesheet{R_}{{{/ptxpath}/{document/diglotsecprj}/PrintDraft/PrintDraft-mods.sty}} % Right-side/Diglot Secondary stylesheet override settings
{project/ifusemodssty}\stylesheet{L_}{{{/ptxpath}/{project/id}/PrintDraft/PrintDraft-mods.sty}} % Left-side stylesheet override settings
...
%%%%% Hyphenation %%%%%
{paragraph/ifhavehyphenate}{paragraph/ifhyphenate}\input "{/ptxpath}/{project/id}/shared/ptxprint/hyphen-{project/id}.tex"
