...
%\stylesheet{L_}{{{/ptxpath}/usfm.sty}}
...
{project/ifusemodssty}\stylesheet{L_}{{{/ptxpath}/{project/id}/PrintDraft/PrintDraft-mods.sty}} % User can override all other stylesheet settings here

%%%% {document/ifaligndiglot}\stylesheet{{{/ptxpath}/{project/id}/PrintDraft/NestedStyles.sty}}     % PTXprint-generated stylesheet changes (for versenums, ftnts, xref, size + spacing)
{document/ifaligndiglot}{project/ifusemodssty}\stylesheet{{{/ptxpath}/{document/diglotsecprj}/PrintDraft/PrintDraft-mods.sty}} % User can override all other stylesheet settings here
