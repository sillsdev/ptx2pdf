...
\AboveNoteSpace={document/abovenotespace}pt plus {document/abovenotestretch}pt minus {document/abovenoteshrink}pt 
%\AboveNoteSpace=\medskipamount %6pt plus 2pt minus 2pt
