...
{document/ifaligndiglot}\diglotInnerOuter{header/mirrorlayout}
{document/ifaligndiglot}\diglotSepNotes{document/diglotsepnotes}
{document/ifaligndiglot}\initdiglot

%%%%% Stylesheets %%%%%
\stylesheet{L}{{{/ptxpath}/usfm.sty}}
{project/ifusecustomsty}\stylesheet{{{/ptxpath}/{project/id}/custom.sty}}
\stylesheet{L}{{{/ptxpath}/{project/id}/PrintDraft/NestedStyles.sty}}     % PTXprint-generated stylesheet changes (for versenums, ftnts, xref, size + spacing)
{project/ifusemodssty}\stylesheet{L}{{{/ptxpath}/{project/id}/PrintDraft/PrintDraft-mods.sty}} % User can override all other stylesheet settings here
...
%%%%% Text Spacing %%%%%
\def\LineSpacingFactor{L}{{{paragraph/linespacingfactor}}}
\def\VerticalSpaceFactor{L}{{1.0}}
...
%%%%% Fonts %%%%%
\FontSizeUnit{L}={paper/fontfactor}pt
%% Faces
\def\regular{L}{{"{fontregular}{fontregular/engine}{font/texfeatures}{document/script}{document/digitmapping}"}}
\def\bold{L}{{"{fontbold}{fontbold/engine}{font/texfeatures}{document/script}{document/digitmapping}{fontbold/embolden}{fontbold/slant}"}}
\def\italic{L}{{"{fontitalic}{fontitalic/engine}{font/texfeatures}{document/script}{document/digitmapping}{fontitalic/embolden}{fontitalic/slant}"}}
\def\bolditalic{L}{{"{fontbolditalic}{fontbolditalic/engine}{font/texfeatures}{document/script}{document/digitmapping}{fontbolditalic/embolden}{fontbolditalic/slant}"}}
{document/ifspacing}\def\SpaceStretchFactor{L}{{{document/spacestretch}}}
{document/ifspacing}\def\SpaceShrinkFactor{L}{{{document/spaceshrink}}}
...
\RTL{L}{document/ifrtl}   % Use right-to-left layout mode?
...
%%%%% Fuzzy Diglot settings (unused if AlignedDiglot is active)
{diglot/fzysettings}
