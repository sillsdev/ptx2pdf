...
%%%%% Text Spacing %%%%%
{paragraph/fixlinespacing}\def\LineSpacingFactor{{{paragraph/linespacing}}}
\def\LineSpacingFactor{{1.0}}
\def\VerticalSpaceFactor{{1.0}}
{paragraph/varlinespacing}\baselineskip={paragraph/linespacing}pt plus {paragraph/linemax}pt minus {paragraph/linemin}pt
