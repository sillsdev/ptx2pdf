...
{paper/ifgrid}\def\doLines{{{paper/notelines}}}
...
{document/marginalverses}\def\colshiftmode{{{document/marginalposn}}}\def\vhyphenmode{{{texpert/vhyphenmode}}}
...
{document/nogrid}{document/varlinespacing}\def\ColAdjskip{{0pt plus {texpert/interlinestretch}pt minus {texpert/interlineshrink}pt}}
...
%%%%% Layout %%%%%
{texpert/showhboxerrorbars}\overfullrule=0pt
...
\OmitAllVersestrue {document/ifshowversenums}\OmitAllVersesfalse

{document/hangpoetry}\hangpoetry
...
\def\RangeChapSeparator{{\kern.1em{chaprangesep_}\kern.1em}}
\def\BookChapSeparator{{{bksep_}}}
...
\ifnum\pageno<1 \pageno={document/startpagenum}\fi
{document/ifdiglot}\diglottrue
...
{cover/makecoverpage}{document/ifdiglot}\inptxfiletrue\zglot|L\* 
