...
{document/ifdiglot}{project/ifusemodssty}\stylesheet{R_}{{{/ptxrpath}/{document/diglotsecprj}/PrintDraft/PrintDraft-mods.sty}} % Right-side/Diglot Secondary stylesheet override settings
