...
%%%%% Text Spacing %%%%%
{paragraph/fixlinespacing}\def\LineSpacingFactor{{{paragraph/linespacing:.2f}}}
\def\LineSpacingFactor{{1.0}}
\def\VerticalSpaceFactor{{1.0}}
{paragraph/varlinespacing}\baselineskip={paragraph/linespacing:.2f}pt plus {paragraph/linemax:.2f}pt minus {paragraph/linemin:.2f}pt
...
% This next option is yet to be implemented. Will only be active if "Use PT macros" is False AND "Start half page" is True
{project/ifuseptmacros}{project/ifstarthalfpage}\StartNextBookOnLastPageOfPrevious
