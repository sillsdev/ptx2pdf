...
#    "versehyphen":        O("vhyphen", "CVS", True, "", _("Margin Verse Hyphens"), _("In marginal verses, do we insert a hyphen between verse ranges?")),
    ...
    "afterChapterSpace":  O("afterchapterspace", "CVS", (0.25, -0.20, 1.0, 0.01, 0.10, 2), r"\def{0}{{{1}}}", _("After chapter space factor"),
    ...
    "afterVerseSpace":    O("afterversespace", "CVS", (0.15, -0.20, 1.0, 0.01, 0.10, 2), r"\def{0}{{{1}}}", _("After verse space factor"),
    ...
    "underlinePosition":  O("underlineposition", "FNT", (0.10, -1.0 , 1.0, 0.01, 0.01, 2), r"\def{0}{{{1}}}", _("Underline vertical position (em)"),
