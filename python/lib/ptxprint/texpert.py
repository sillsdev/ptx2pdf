...
texpertOptions = {
    ...
    "NoteLineXoffset":    O("notelineoffset", "LAY", (6, 0.0, 100.0, 0.2, 2.0, 1), r"\def{0}{{{1}pt}}", _("Noteline offset (pt)"), 
                            _("Gap (pt) between noteline and text")),
    "NoteLineXmargin":    O("notelinemargin", "LAY", (20,0.0,100.0, 0.2, 2.0, 1), r"\def{0}{{{1}pt}}", _("Noteline margin (pt)"), 
                            _("Gap (pt) between noteline and edge of page")),
    ...
    "NoteLineY":          O("noteliney", "LAY", (0, 0.00, 100.00, 0.10, 0.50, 2), r"\def{0}{{{1}mm}}",_("Noteline spacing (mm)"), 
