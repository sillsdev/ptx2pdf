...
texpertOptions = {
    ...
    "RiverMinMaxWidth":   O("riverminmaxwidth", "PRV", (1, 0.1, 5, 0.1, 1, 0), "", _("River Detection minimum required maximum width (em)"),
                            _("Minimum width required for the widest part of the river")),
    "RiverWidth":         O("riverminwidth", "PRV", (0.5, 0.5, 5, 0.1, 1.0, 1), "", _("River Detection minimum width (em)"),
