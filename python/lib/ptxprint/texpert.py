...
#    "versehyphen":        ["vhyphen", True, "", _("Margin Verse Hyphens"), _("In marginal verses, do we insert a hyphen between verse ranges?")],
    ...
    "BookStartPage": ["bookstartpage", {"page": _("Next page"), "multi": _("Same page"), "odd": _("Odd page")}, r"\def{0}{{{1}}}", _("Where to start a new book"), _("Does a scripture book start on a new page, the same page as the previous book, or an odd page")],
    "IntroPageAlign":     ["intropagealign", {"page": _("Next page"), "multi": _("No page breaks"), "odd": _("On an odd page")}, r"\def{0}{{{1}}}", _("Where to start a new intro page"), _("Does an intro page start on a new page, the same page as the previous book, or an odd page")],
