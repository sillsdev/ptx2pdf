...
texpertOptions = {
    ...
    "NoteLineXoffset":   O("notelineoffset", "LAY", (10, 0, 100,  0.2, 2, 1), r"\def{0}{{{1}pt}}", _("Noteline offset"), _("Gap between noteline and text")),
    "NoteLineXmargin":   O("notelinemargin", "LAY", (28.4,0,100, 0.2, 2, 1), r"\def{0}{{{1}pt}}", _("Noteline margin"), _("Gap between noteline and edge of page")),
    "NoteLineRuleType":    O("notelinetype", "LAY", 
                            {"rule": _("A line"), "dots": _("A row of dots")}, r"\def{0}{{{1}}}", 
                            _("Noteline type"), _("Sometimes it is preferable to use a series of dots rather than a solid line.")),
    "NoteLineLineMajor":   O("notelinemajor", "LAY", (0.5, 0, 10, 0.01, 0.01, 2), r"\def{0}{{{1}pt}}",_("Noteline width (major)"), _("Thickness of major notelines. Specify the colour (R G B) with \\def\\NoteLineColMajor{0 0.5 0}")),
    "NoteLineLineMinor":   O("notelineminor", "LAY", (0.5, 0, 10, 0.01, 0.01, 2) ,r"\def{0}{{{1}pt}}", _("Noteline width (minor)"), _("Thickness of minor notelines. Specify the colour (R G B) with \\def\\NoteLineColMinor{0.5 0 0")),
    "NoteLineMajorDiv":   O("notelinediv", "LAY", (0, 0, 100, 1, 5, 0), r"\def{0}{{{1}}}", _("Noteline subdivisions"), _("Major noteline happens at the start then every this many lines after.")),
...
#    "versehyphen":        O("vhyphen", "CVS", True, "", _("Margin Verse Hyphens"), _("In marginal verses, do we insert a hyphen between verse ranges?")),
    ...
    "underlineLower":     O("underlineposition", "FNT", (0.10, -1.0 , 1.0, 0.01, 0.01, 2), r"{0}={1}", _("Underline vertical position (em)"),
