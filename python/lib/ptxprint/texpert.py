...
texpertOptions = {
    ...
    "NoteLineXoffset":    O("notelineoffset", "LAY", (2.1, 0.0, 100.0, 0.1, 2.0, 1), r"\def{0}{{{1}mm}}", _("Noteline offset (mm)"), 
                            _("Gap (mm) between noteline and text")),
    "NoteLineXmargin":    O("notelinemargin", "LAY", (10.0,0.0,100.0, 0.1, 2.0, 1), r"\def{0}{{{1}mm}}", _("Noteline margin (mm)"), 
