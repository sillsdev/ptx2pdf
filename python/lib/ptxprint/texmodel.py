...
ModelMap = {
    ...
    "document/diglotprifraction": ("s_diglotPriFraction", lambda w,v : round((v/100), 3) if v is not None else "0.550"),
    "document/diglotsecfraction": ("s_diglotPriFraction", lambda w,v : round(1 - (v/100), 3) if v is not None else "0.450"),
