...
class Info:
    _mappings = {
        ...
        "document/abovenotespace":      ("s_abovenotespace", lambda w,v: v),
        "document/abovenotestretch":    ("s_abovenotestretch", lambda w,v: v),
        "document/abovenoteshrink":     ("s_abovenoteshrink", lambda w,v: v),
