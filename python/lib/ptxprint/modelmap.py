...
_map = {
    ...
    "ifdiglotincludefootnotes_":("_diglotinclfn", "diglot", lambda w,v: "%" if not v else ""),
    "ifdiglotincludexrefs_":    ("_diglotinclxr", "diglot", lambda w,v: "%" if not v else ""),
    ...
    "paper/headerpos":          ("s_headerposition", "layout", None),
    "paper/footerpos":          ("s_footerposition", "layout", None),
    "paper/rulegap":            ("s_rhruleposition", "layout", None),
    ...
    "header/ifshowbook":        ("c_rangeShowBook", "layout", lambda w,v :"false" if v else "true"),
    "header/ifshowchapter":     ("c_rangeShowChapter", "layout", lambda w,v :"false" if v else "true"),
    "header/ifshowverse":       ("c_rangeShowVerse", "layout", lambda w,v :"true" if v else "false"),
    "header/chvseparator":      ("r_CVsep", "layout", lambda w,v : ":" if v == "colon" else "."),
    "header/ifrhrule":          ("c_rhrule", "layout", lambda w,v: "" if v else "%"),
    "header/hdrleftside":       ("r_hdrLeft", "layout", None),
    "header/hdrleft":           ("ecb_hdrleft", "layout", lambda w,v: v or "-empty-"),
    "header/hdrcenterside":     ("r_hdrCenter", "layout", None),
    "header/hdrcenter":         ("ecb_hdrcenter", "layout", lambda w,v: v or "-empty-"),
    "header/hdrrightside":      ("r_hdrRight", "layout", None),
    "header/hdrright":          ("ecb_hdrright", "layout", lambda w,v: v or "-empty-"),
    "header/mirrorlayout":      ("c_mirrorpages", "layout", lambda w,v: "true" if v else "false"),
    
    "footer/ftrcenterside":     ("r_ftrCenter", "layout", None),
    "footer/ftrcenter":         ("ecb_ftrcenter", "layout", lambda w,v: v or "-empty-"),
    "footer/ifftrtitlepagenum": ("c_pageNumTitlePage", "layout", lambda w,v: "" if v else "%"),
    "footer/ifprintconfigname": ("c_printConfigName", "layout", lambda w,v: "" if v else "%"),
