...
\iftrue
  \def\paperY{21cm}
  \def\paperX{29.69cm}
  \dimen1=9.5cm % Sample height
  \dimen2=29.69cm % orig A4 height
  \edef\SampleY{\the\dimen1}
  \edef\SampleX{\the\dimexpr 0.707\dimen1\relax}
\else
  \def\paperX{21cm}
  \def\paperY{29.69cm}
  \dimen1=9cm % Sample height
...
\def\scale@borderlpadding{1}
\def\scale@borderrpadding{1}
\def\scale@bordertpadding{1}
\def\scale@borderbpadding{1}
\def\scale@boxtpadding{1}
\def\scale@boxbpadding{1}
\def\scale@boxlpadding{1}
\def\scale@boxrpadding{1}
...
\def\demoborder #1|#2 #3\E{%
  \boxornfalse
  \noindent\leavevmode\traceifset{demob}%
  \bgroup\PaperHeight=\SampleY \PaperWidth=\SampleX 
    ...
    \esbe
    %\global\setbox\demopages\hbox{\unhbox\demopages \hskip 10pt plus 1fil \box\wholepagepic} 
    \box\wholepagepic \hskip 5pt plus 10em 
  \egroup 
    \lineskip=15pt
  \traceifcheck{demob}
  \penalty0
...
\bigorn{54}{pgfhan}
%Green and yellow
\SetupOrnament{0.3}{0.0 0.5 0.2}{0.8 0.7 0.2}
\def\typeout#1{}
...
\def\testornamentsh{
  ...
  \SetupOrnament{0.3}{0.8 0.2 0.2}{0.8 0.7 0.0}
  ...
  \ornloop
  \ornscaletrue
  \SetupOrnament{1}{0.0 0.5 0.2}{0.8 0.7 0.2}
  \count255=100
  \def\max{108}
  \ornloop
  \hfil\par
  \xdef\ornamentheight{95pt}\xdef\ornamentwidth{}\xdef\ornamentmaxwidth{\the\dimexpr 0.9\hsize\relax}
  \ornscaletrue
  \SetupOrnament{0.3}{0.8 0.2 0.2}{0.8 0.7 0.0}
  \the\bigorns
  \par
