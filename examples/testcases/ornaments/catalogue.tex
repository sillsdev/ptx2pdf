...
\x@\def\csname scalefrm@a5\endcsname{0.707}
\x@\def\csname scalefrm@a4\endcsname{0.5}
...
\def\modcat #1|#2 {\def\d@##1\E{%
  \getp@r@m{##1}{bdr-#1}\ifx\p@ram\relax\else
    ...
    \fi}\x@\cstackdown\b@rderparameters,\E
}

\def\demoborder #1|#2 #3\E{\boxornfalse\bgroup\PaperHeight=14.8cm\PaperWidth=10.5cm \modcat #1|#2 \esb\cat testpage\cat* 
  \vfill \pc #1 on #2 \pc #3 \vfill \esbe\leavevmode \hbox{\box\wholepagepic} \egroup }
