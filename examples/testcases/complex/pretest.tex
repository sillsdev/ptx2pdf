...
\fi
\x@\count\csname note-f\endcsname=500
...
\m@rgedims{a:1pt,b:3pt}+{c:1pt,b:1pt}
\res@tm@reged
\message{merged result \@mtmp}
\edef\test{a:\the\dimexpr 1.0pt\relax,b:\the\dimexpr 4.0pt\relax,c:\the\dimexpr 1.0pt\relax}
\ifx\@mtmp\test\else\errmessage{!!! Failed \meaning\test != \meaning\@mtmp}\fi
...
%\notracing{imt}
\message{note-f: \the\count\csname note-f\endcsname}
\dimen0=43.94527pt
\divide\dimen0 by 1000
\message{dimencalc: \x@\the\x@\dimexpr \count\csname note-f\endcsname\dimen0\relax}%
%\showbox\excessL
...
\tracingmacros=3 \tracingassigns=3
\x@\let\csname this@c@cut\x@\endcsname\csname 1-0@cut\endcsname
\this@c@cut=28\try@cut{R}
...
\relax
%\message{Last insert: \the\insc@unt/\the\et@xins, count:\the\count10,  dim: \the\count11, box: \the\count14}
\bye
