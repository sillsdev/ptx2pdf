...
\def\DiglotLeftFraction{0.39} % In case texts fit better with unequal columns
\def\DiglotRightFraction{0.61} 
...
\BindingGutterfalse % add extra margin of \BindingGutter on binding side
%\BindingGutter=10pt
%\BindingGutter=20pt
\DoubleSidedtrue
