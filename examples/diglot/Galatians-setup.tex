...
\def\DiglotLeftFraction{0.38} % In case texts fit better with unequal columns
\def\DiglotRightFraction{0.62} 
...
\sethook{before}{add}{\lower 1pt \hbox{\vrule width \addmtlqutelw height \addmtlquteht\vrule width \addmtlqutewd height \addmtlqutelw}\kern -1pt\ignorespaces}
