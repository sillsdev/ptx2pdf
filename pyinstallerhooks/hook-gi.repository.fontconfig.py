...
def hook(hook_api):
    module_info = GiModuleInfo('fontconfig', '2.0', hook_api=hook_api)  # Pass hook_api to read version from hook config
    ...
    datas += collect_glib_share_files(f'fontconfig-{module_info.version}')
