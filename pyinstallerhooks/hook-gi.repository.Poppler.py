...
def hook(hook_api):
    module_info = GiModuleInfo('Poppler', '0.18', hook_api=hook_api)  # Pass hook_api to read version from hook config
    ...
    datas += collect_glib_share_files(f'Poppler-{module_info.version}')
