...
def hook(hook_api):
    module_info = GiModuleInfo('win32', '1.0', hook_api=hook_api)  # Pass hook_api to read version from hook config
    ...
    datas += collect_glib_share_files(f'win32-{module_info.version}')
