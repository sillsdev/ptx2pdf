...
a = Analysis(['python/scripts/ptxprint'],
             ...
             datas=[('python/lib/ptxprint/ptxprint.glade', 'ptxprint'),
					...
					('python/lib/ptxprint/A4-Grid.pdf', 'ptxprint'),
					('python/lib/ptxprint/A4-Draft.pdf', 'ptxprint'),
					('python/lib/ptxprint/A5-Grid.pdf', 'ptxprint'),
					('python/lib/ptxprint/A5-Draft.pdf', 'ptxprint'),
					('python/lib/ptxprint/DiglotSample700px.png', 'ptxprint'),
					('python/lib/ptxprint/ps_cmyk.icc', 'ptxprint'),
                    ('src/*.tex', 'src/mappings/*.tec', 'ptx2pdf')],
