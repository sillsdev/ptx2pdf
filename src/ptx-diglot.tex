...
\def\doDiglotLeftTrial{%
  ...
  \fi
  \joinboxes{\LeftBox}{\partialL}{10}{\Lboxpenalty}\par\penalty-10005
...
\def\diglotRight{%
 ...
 \ifnum\holdinginserts=0 %Inserts not held, continue
         \digl@tRight%
 \else%
        %\oDiglotRightTrial% FIXME - still broken?
        \digl@tRight%
 \fi%
}
...
\outer\def\righttext{\global\savedpenalty=\lastpenalty\n@xtc@mmand\global\holdinginserts=1
  ...
  \ifhe@dings\endhe@dings\fi\par\penalty-10001
...
% to line up nicely...
\def\norighttext{\global\savedpenalty=\lastpenalty\relax\trace{D}{norighttext}\Lneedsemptyingtrue
  \par\penalty-10001
