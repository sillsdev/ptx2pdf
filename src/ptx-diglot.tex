...
\def\stylesheetL#1{\gdef\ds@ffix{L}\stylesheet{#1}}
\def\stylesheetR#1{\gdef\ds@ffix{R}\stylesheet{#1}}

\def\LR#1{\x@\gdef\csname #1\endcsname{\csname #1\ifdiglot\ifdiglotL L\else R\fi\fi\endcsname}}
