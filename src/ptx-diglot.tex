...
\def\ch@ckLR#1#2{\x@\let\x@\myt@mp\csname#1#2\endcsname\ifx\myt@mp\relax\ifdiglot\MSG{Side-specific #1#2 not defined, global #1}\fi\x@\let\csname#1#2\x@\endcsname\csname #1@rig\endcsname\fi}
