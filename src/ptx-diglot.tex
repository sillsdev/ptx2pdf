...
\addtoendhooks{\bgroup\count255=\cumulativeDelta \divide\count255 by \pageno \ifdiglot\message{Overall column delta \the\cumulativeDelta pt (\the\count255 pt/ pg)\space(-ve means left longer)}\egroup\cumulativeDelta=0 \fi}
