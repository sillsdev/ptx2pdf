...
%
 ...
 \ifdim\ht255<-20pt % eek. we've been given a seriously -ve height box.
  \ifleftfull
  \else
    \message{*** SOMETHING BAD HAPPENED on page \the\pageno. Probably a picture that there was no space for.}%
    \leftfulltrue
  ...
  \ifdim\availht<\trialheight
    \ifdim\availht<0pt
      \bgroup
        ...
        \message{*** A picture or footnote on page \the\pageno (near \botmark) has just taken \the\dimen0 of space. There's no space left for text.}%
      \egroup
     \fi
    \global\trialheight=\availht
  \fi
...
\outer\def\lefttext{%
  ...
  \ifinn@te\message{*** lefttext called from inside footnote?!?}\fi
  \Lneedsemptyingtrue%
  \calc@vailht%
  \n@xtc@mmand%
...
\newdimen\baselineDelta % difference between the L and R baselines (-ve=left longer)
\newdimen\thisjointDelta % difference between the L and R baselines (-ve=left longer)
...
\def\upd@tep@rtial{%Actually add stuff to the page.
  ...
  \traceNum{d}{Adding to page: LB:\the\ht\LeftBox+\the\dp\LeftBox\space RB:\the\ht\RightBox+\the\dp\RightBox\space Last Delta:\the\chunkDelta}%
  \ifVisTrace
    \doVisTrace{L}%
  \fi
  ...
  \ifdiglotSepNotes%
    ...
    \ifdiglotBalNotes%
      ...
      \ifLRf@@tnotes%
        ...
        \setbox\LeftBox=\hbox to \textwidth{%\vllap{\the\ht\LeftBox \the\dp\LeftBox}
          ...
          \else%
            \hbox to\columnRwidth{\copy\RightBox\hss}\makediglotgutter{\dimen7}{\dimen8}{\dimen9}%
    ...
    \else %BalNotes
      ...
      \ifLRf@@tnotes%
        ...
        \setbox\LeftBox\hbox to \textwidth{%\vllap{\the\ht\LeftBox \the\dp\LeftBox}
          \ifdiglotN@rmal%are the sides swapped?
            \hbox to\columnLwidth{\copy\LeftBox\hss}\makediglotgutter{\dimen8}{\dimen8}{\dimen9}%
            \hbox to\columnRwidth{\copy\RightBox\hss}%\rlap{\the\ht\RightBox \the\dp\RightBox}
          \else%
            \hbox to\columnRwidth{\copy\RightBox\hss}\makediglotgutter{\dimen8}{\dimen8}{\dimen9}%
            \hbox to\columnLwidth{\copy\LeftBox\hss}%\rlap{\the\ht\RightBox \the\dp\RightBox}
          \fi%
        }%
        %\advance\dimen2 by -\ht\RightBox % dimen2 is step in footnotes
...
\def\makediglotgutter#1#2#3{\hbox to0.5\columnshift{}\hbox to \gutter{\hss
