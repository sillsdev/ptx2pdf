...
%the depth is not recoverable we add a kern to remove the orignial depth.
 \trace{D}{makevtop #1, before vtop dp=\the\dp#1}%
...
\ifvoid#1\else%
  ...
  \setbox0=\lastbox%
  \copy0%
  \traceNum{d}{final bit of deconstructed first box \the\ht0+\the\dp0}%
...
\def\upd@tep@rtial{%
  ...
  \ifVisTrace
  \setbox0=\vtop to 0pt{\hrule height 0pt depth 0.5pt width 15pt\hbox{\the\TRACEcount}\vss}\ht0=0pt\dp0=0pt
  \fi
