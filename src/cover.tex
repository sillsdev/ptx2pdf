...
\def\c@verbit#1#2{%
  ...
  \h@ldfigtrue
  \bgroup
    \PaperHeight=\the\dimexpr\csname cover-y-#1\endcsname \relax
    \PaperWidth=\the\dimexpr\csname cover-x-#1\endcsname\relax
    \hsize=\PaperWidth
...
\def\d@spine{%
  \ifrotatespine
    \trace{cov}{Rotating spine}%
    \setbox0\hbox{\c@verbit{spine}{\topskip=1pt plus 1fil \csname periphcontents=spine\endcsname}}%
...
\def\m@kecover{%
  ...
  %    \tracingall
      \ifBookOpenLeft
	\hbox{\c@verbit{front}{\csname periphcontents=frontcover\endcsname}%
	\d@spine
	\c@verbit{back}{\csname periphcontents=backcover\endcsname}}%
      \else
	\hbox{\c@verbit{back}{\csname periphcontents=backcover\endcsname}%
	\d@spine
  ...
  \showbox0
  \ship@utcoverinsert{cover}{\box0}{\coverX}{\coverY}{\csname cover-y-spine\endcsname}{\csname cover-bleed\endcsname}%
}
