...
\def\m@kecover{%
  ...
  \ifcsname periphcontents=coverfront\endcsname\trace{cov}{coverfront exists}%
    ...
    \fi
  \else
    \ifcsname periphcontents=cover\endcsname\trace{cov}{cover exists}%
  ...
  \else
    \message{No cover produced, as periphery missing (\ifcsname periphcontents=coverfront\endcsname\else coverfront (or cover)\fi\ \ifcsname periphcontents=coverback\endcsname coverback\fi)}%
  \fi
}
