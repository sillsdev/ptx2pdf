    ...
    \setbox0\hbox{%
      \c@verbit{spine}{\topskip=0pt 
        ...
        \ifcsname periphcontents=coverspine\endcsname
          \csname periphcontents=coverspine\endcsname
        \else
          \csname periphcontents=spine\endcsname
        \fi
        \vfill
...
\def\m@kecover{%
  ...
  \else
    \message{No cover produced, as periphery missing (state: \ifcsname periphcontents=coverfront\endcsname\else No coverfront (or cover). \fi\ifcsname periphcontents=coverback\endcsname\else, No coverback \fi \ifcsname periphcontents=coverspine\endcsname\else \ifcsname periphcontents=spine\else, No coverspine (or spine).\fi\fi)}%
  \fi
}
\StorePeriph{cover}
\StorePeriph{spine}
