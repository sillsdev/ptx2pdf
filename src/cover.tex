...
\def\c@verbit#1#2{%
  ...
  \bgroup
    ...
    \esbe%
    \bgroup
      \s@tc@tprefix{cover_#1}\getsbp@ram{borderbottom}\ifx\cp@ram\tr@e
...
\def\m@kecover{%
  ...
  \ifcsname periphcontents=wholecover\endcsname\else\temptrue\fi
  \iftemp
    %\tracingassigns=1
    \cover@maths
    %\tracingassigns=0
    \setbox0\vbox to \csname cover-Y-whole\endcsname{\topskip=0pt \lineskip=0pt%
      ...
      \bgroup
        \s@tc@tprefix{cover_whole}\getsbp@ram{boxtpadding}\ifx\cp@ram\relax\else
      ...
      \c@verbit{whole}{\topskip=0pt \lineskip=0pt
        ...
        \ifcsname  periphcontents=wholecover\endcsname
          \vbox to 0pt{\vskip \wholec@vrtpad\vbox to \dimexpr \csname cover-Y-whole\endcsname -\wholec@vrtpad -\wholec@vrbpad\relax{%
