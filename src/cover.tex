...
\def\c@verbit#1#2{%
  ...
  \bgroup
    \def\t@stsz{1}%
    %\def\t@stsz{.33}%
    \PaperHeight=\the\dimexpr \t@stsz\dimexpr\csname cover-Y-#1\endcsname 
   %   \ifble@d +\tble@d+\bble@d\fi
    \relax\relax
    \PaperWidth=\the\dimexpr \t@stsz\dimexpr\csname cover-X-#1\endcsname 
   %   \ifble@d +\rble@d+\lble@d\fi
    \relax\relax
    \hsize=\PaperWidth
