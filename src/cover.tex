...
\def\leftble@d{%
  \edef\lble@d{\csname cover-bleed\endcsname}%  \edef\tble@d{\csname cover-bleed\endcsname}%
  \edef\rble@d{0pt}%
  \udble@d
}
\def\rightble@d{%
...
\def\m@kecover{%
  \temptrue
  \ifcsname periphcontents=frontcover\endcsname\trace{cov}{frontcover exists}%
    \x@\let\x@\tmp\csname periphcontents=frontcover\endcsname \ifx\tmp\empty
      \trace{cov}{...but it's empty}%
      \tempfalse
    \fi
  \else\tempfalse\fi
  \ifcsname periphcontents=backcover\endcsname\trace{cov}{backcover exists}%
    \x@\let\x@\tmp\csname periphcontents=backcover\endcsname \ifx\tmp\empty
      \trace{cov}{...but it's empty}%
      \tempfalse
    \fi
  \else\tempfalse\fi
  \ifcsname periphcontents=wholecover\endcsname\trace{cov}{wholecover exists}%
    \tracingassigns=1
    \x@\let\x@\tmp\csname periphcontents=wholecover\endcsname \ifx\tmp\empty
      \trace{cov}{...but it's empty}%
    \else
  ...
  \iftemp
    ...
    %    \tracingall
        ...
        \else
          \hbox{\setbox0\hbox{\leftble@d
            ...
            \trace{cov}{back cover is \l@gdims0}%
            \box0
            {%
              \ble@dtrue
              \d@spine
    ...
    \ship@utcoverinsert{cover}{0}{\csname cover-spine\endcsname}{\ifble@d \csname cover-bleed\endcsname \else 0pt\fi}%
  \else
...
\StorePeriph{wholecover}
\KeepPeriph{frontcover}
\KeepPeriph{backcover}
\KeepPeriph{spine}
\KeepPeriph{wholecover}
