...
\or\def\@pgfornamentX{120}\def\@pgfornamentY{123}%  76
\or\def\@pgfornamentX{120}\def\@pgfornamentY{123}%  77
\or\def\@pgfornamentX{123}\def\@pgfornamentY{69}%  78
\fi%
\ifx\@pgfornamentX\relax
  \ifcase\numexpr #1-100\relax%
    \def\@pgfornamentX{40}\def\@pgfornamentY{40}%  100
  \or\def\@pgfornamentX{50}\def\@pgfornamentY{50}%  101
  \or\def\@pgfornamentX{50}\def\@pgfornamentY{50}%  102
  \or\def\@pgfornamentX{150}\def\@pgfornamentY{50}%  103
  \or\def\@pgfornamentX{150}\def\@pgfornamentY{50}%  104
  \or\def\@pgfornamentX{150}\def\@pgfornamentY{50}%  105
  \or\def\@pgfornamentX{150}\def\@pgfornamentY{50}%  106
  \or\def\@pgfornamentX{150}\def\@pgfornamentY{50}%  107
  \else
    \message{Unknown ornament #1}%
    \def\@pgfornamentX{100}\def\@pgfornamentY{100}%  Just something so there are less crashes
  \fi
\fi
}%
\makeatother
