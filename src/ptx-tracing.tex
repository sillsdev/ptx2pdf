...
\def\tracelist{A,b,B,C,c,ch,cov,d,dP,D,De,Df,Dh,Ds,dm,dmp,dmc,dmcr,e,eg,eb,ebi,eh,et,f,fp,F,Fe,g,G,gI,h,hv,H,i,imt,I,j,m,mx,M,ma,n,nS,o,oh,orn,p,pt,P,per,s,sa,sb,spv,ss,sP,sc,sC,sh,sk,sko,S,t,tim,T,u,V,v,x,}
...
\def\y@s{y}
\def\tracing#1{\x@\xdef\csname tr@cemode-#1\endcsname{\y@s}\let\trace=\@@tr@cer \x@\let\csname tr@ce-#1\endcsname\tr@ceout}%
...
\def\FastTracing{\message{Using FastTracing}\global\let\trace\tr@cerfast\let\@@tr@cer\tr@cerfast}
