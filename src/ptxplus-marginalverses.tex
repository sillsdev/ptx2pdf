...
\def\mymarginpverse{%
  ...
  \fi
  \ifx\vhyphenmode\gr@dnone\versehyphenfalse\versehyphenupfalse\else
    \ifx\vhyphenmode\@top\versehyphenuptrue\else
    \ifx\vhyphenmode\@bottom\versehyphenupfalse\else
    \ifx\vhyphenmode\l@ft\ifrsh@ft\versehyphenuptrue\else\versehyphenupfalse\fi\else
    \ifx\vhyphenmode\r@ght\ifrsh@ft\versehyphenupfalse\else\versehyphenuptrue\fi
  \fi\fi\fi\fi\fi
  \trace{v}{hyphenmode=\vhyphenmode, hyphen=\ifversehyphenup up\else down\fi}%
  ...
  \else
    ...
    \setbox2=\vtop{\everypar={}\hbox to \VerseBoxWidth{%
        ...
        \ifrsh@ft\kern\AfterVerseSpaceFactor\FontSizeUnit\else\hfil\fi}}%
    \def\t@@mp{bottom}%
    \dimen1=-\dp2 \divide\dimen1 by 2 \advance\dimen1 by -\dp\pstr@t
  \fi
  ...
  \ifversion{5}{\d@marginnote{2}{\mt@mp}{v}{\colshiftmode}{\t@@mp}{\the\dimen0}{\the\dimen1}}{\d@marginnote{2}{\mt@mp}{v}{\colshiftmode}{center}{\the\dimen0}{\the\dimen1}}%
  \outputmvmkr
}
