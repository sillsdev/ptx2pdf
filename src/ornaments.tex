...
\def\OrnamentBorder#1{%
  ...
  %\trace{eb}{bbh=\b@rderbox@height,t:\l@gdims{\orn@bdr@top}, l:\l@gdims{\orn@bdr@left}, r:\l@gdims{\orn@bdr@right}, b:\l@gdims{\orn@bdr@bot}}%
  \setbox\b@rderbox\vbox to \b@rderbox@height{\let\par\endgraf\everypar={}\baselineskip=0pt \lineskip=0pt \hsize=\b@rderbox@width \relax \lineskiplimit=0pt
    \hbox{\box\orn@bdr@top}\hbox to \b@rderbox@width{\box\orn@bdr@left\hskip\border@l@pad\hss\hbox{\vbox to \dimen1{}}\hskip\border@r@pad\hss\box\orn@bdr@right\kern-\b@drwidth\OrnamentUnit}\baselineskip=\ht\orn@bdr@bot\relax
    \box\orn@bdr@bot}%
