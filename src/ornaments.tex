...
\def\s@tornamenttransform#1#2#3#4{%
  ...
  \def\pdf@xo{-\x@bjpadding}\def\pdf@yo{-\x@bjpadding}%
  \calc@ornamentdim
  \ifdim\dimen0<0pt
    \dimen0=-\dimen0
    \edef\pdf@xo{\strip@pt{\dimexpr 0.99626401\dimen0\relax}}%
  \fi
  \ifdim\dimen1<0pt
    \dimen1=-\dimen1
    \edef\pdf@yo{\strip@pt{\dimexpr 0.99626401\dimen1\relax}}%
  \fi
  \edef\pdf@matrix{}%
  ...
  %\iftrue
    ...
    \edef\pdf@xo{\strip@pt{\dimexpr \pdf@xo pt + \x@bjpadding \relax}}% Actually bp
    \edef\pdf@yo{\strip@pt{\dimexpr \pdf@yo pt + \x@bjpadding \relax}}% Actually bp
