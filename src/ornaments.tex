...
\def\OrnamentBorder#1#2{%
  ...
  \edef\box@width{\dimexpr \wd#1 +\fb@hpadding*2 + #2 *\b@drsides+ \border@hpadding * \b@drsides\relax}%%
  \edef\b@drsides{\the\numexpr \ifx\b@drtop\tr@e 1 +\fi \ifx\b@drbottom\tr@e 1+\fi 0\relax}%
  \edef\box@height{\dimexpr \ht#1 +\fb@vpadding +\dp#1 + #2 *\b@drsides + \border@vpadding *\b@drsides\relax}%
  \ifx\b@drtop\tr@e
  ...
  \dimen2=\dimexpr \dimen1 - \ht#1\relax
  \divide\dimen2 by \b@drsides
  %\def\ornamentheight{}
  %\def\ornamentwidth{#3}
  \message{Box side portion is \the\dimen1. Orig: \the\ht#1 +\the\dp#1 x\the\wd#1, final:\the\box@height }%
  \tempfalse
  \def\border@l@pad{}\def\border@r@pad{}%
  ...
  \ifx\b@drleft\tr@e
    ...
    \def\border@l@pad{\hskip\border@hpadding}%
    \ifx\patternL\patternR
      \ifx\b@drright\tr@e
	\setbox\orn@bdr@right\copy\orn@bdr@left
        \def\border@r@pad{\hskip\border@hpadding}%
      \fi
    \fi
  \else
  ...
  \showboxbreadth=9999
  %\showbox\orn@bdr@right
  \setbox#1\vbox to \box@height{\baselineskip=0pt\lineskip=0pt\hsize=\box@width\box\orn@bdr@top\hbox to \box@width{\box\orn@bdr@left\border@l@pad\hss\hbox{\vbox to \dimen1{\ifx\b@drtop\tr@e\kern\dimen2\fi\box#1\ifx\b@drbottom\tr@e\kern\dimen2\fi}}\border@r@pad\hss\box\orn@bdr@right}\baselineskip=\ht\orn@bdr@bot\box\orn@bdr@bot}%
  %\showbox#1
}
