...
\def\OrnamentBorder#1#2{%
  ...
  \setbox\b@rderbox\vbox to \box@height{\baselineskip=0pt\lineskip=0pt\hsize=\box@width
    \box\orn@bdr@top\hbox to \box@width{\box\orn@bdr@left\hskip\border@l@pad\hss\hbox{\vbox to \dimen1{}}\hskip\border@r@pad\hss\box\orn@bdr@right}\baselineskip=\ht\orn@bdr@bot\box\orn@bdr@bot}%
  %\showbox#1
  \x@\setbox#1\vbox{\vbox to 0pt{\vskip\dimen7\hbox to \box@width{\hskip\dimen8\hss\box#1\hss\hskip\dimen9}\vss}\box\b@rderbox}%
}
