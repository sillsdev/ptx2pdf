...
\def\OrnamentBorder#1#2{%
  ...
  \edef\box@width{\dimexpr \wd#1 + #2 *\b@drsides+ \fb@hpadding * \b@drsides\relax}%%
  \edef\b@drsides{\the\numexpr \ifx\b@drtop\tr@e 1 +\fi \ifx\b@drbottom\tr@e 1+\fi 0\relax}%
  \edef\box@height{\dimexpr \ht#1 +\dp#1 + #2 *\b@drsides + \fb@vpadding *\b@drsides\relax}%
  \ifx\b@drtop\tr@e
  ...
  \showboxbreadth=9999
  %\showbox\orn@bdr@right
  \setbox#1\vbox to \box@height{\baselineskip=0pt\lineskip=0pt\hsize=\box@width\box\orn@bdr@top\hbox to \box@width{\box\orn@bdr@left\hss\hbox{\vbox to \dimen1{\ifx\b@drtop\tr@e\kern\dimen2\fi\box#1\ifx\b@drbottom\tr@e\kern\dimen2\fi}}\hss\box\orn@bdr@right}\baselineskip=\ht\orn@bdr@bot\box\orn@bdr@bot}%
  %\showbox#1
}
