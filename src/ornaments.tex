...
\def\prep@dims#1#2{%Prepare dimensions for calcsc@re. \t@mp is the natural length of the object \t@mpstr=\t@mp if the object is stretchy
  \ifnum #2 > 0 
    ...
    \ifdim \t@mpstr>0pt
      \advance\fill@stretch by #2\dimexpr \t@mpstr\relax %we have more stretch!
    \else
  ...
  \ifdim \dimen0 =0pt % Sanity...
    \dimen0=-100sp
  \fi
  \MSG{Try: remaining:\the\dimen1, stretch:\the\dimen0, \the\dimen2}% 
}
...
\def\calcsc@re{\bgroup \dimen4=\ifdim\dimen1<0pt 0.1\dimen0\else 0.1\dimen2 \fi\count255=\dimen4 
  ...
  \MSG{postcheckdscore: \the\dimen4 (\the\count255) \the\fill@stretch}%
  \print@multi
  \ifnum\count255<\best@score 
    ...
    \message{New best score:\the\best@score, \the\dimen1, \the\best@stretch}%
 \else
...
\def\orn@SetStretch#1#2#3#4{%
  ...
  \begingroup
    ...
    \ifdim\fill@stretch=0pt 
    \else
      \MSG{Stretch = (a:\the\best@adjust,  s:\the\best@stretch) (a+s:\the\dimen4)/s)}%
