...
\def\orn@do@ornament{\bgroup%
    ...
    \ifXformOrnaments
      ...
      \edef\ornUUID{ornament-\ornamentlinewidth\geom@xform-\ornamentlinecol-\ifornamentfill \ornamentfillcol\else nofil\fi-\tpdf@xunit-\tpdf@yunit-\OrnamentsFamily\pdf@ornamentNum}%
    ...
    \iftemp\else 
      ...
      \ifnum 0<  \ifCacheOrnaments 1\fi\ifXformOrnaments 1\fi 0 
        ...
        \x@\xdef\csname \ornUUID-matrix\endcsname{\geom@xform}%
      \trace{orn}{dimens: \the\dimen0 \x@\space x \the\dimen1, 2:\the\dimen2, 3:\the\dimen3, 4:\the\dimen4, 5:\the\dimen5}%
      \fi
    \fi
