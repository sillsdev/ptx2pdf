...
python python\scripts\getstockicons -f inno -s dist\ptxprint -d "{app}" -i applications-system-symbolic -i changes-allow -i changes-prevent -i document-print-symbolic -i document-revert -i document-save-as-symbolic -i edit-clear -i edit-clear-rtl -i edit-clear-symbolic-rtl -i emblem-documents -i folder-documents -i folder-download -i folder-music -i folder-new-symbolic -i folder-open -i folder-open-symbolic -i folder-pictures-symbolic -i folder-videos-symbolic -i format-justify-fill -i go-bottom -i go-first-symbolic -i go-previous-symbolic -i go-next-symbolic -i go-last-symbolic -i go-top -i help-about -i list-add -i list-remove -i media-seek-backward-symbolic -i media-seek-forward-symbolic -i object-select -i open-menu -i pan-down -i pan-end -i pan-up -i preferences-system-sharing -i printer -i software-update-available -i system-run -i user-desktop -i user-home -i text-x-generic-symbolic -i view-dual -i view-grid -i view-fullscreen-symbolic -i media-seek-backward-symbolic-rtl.symbolic -i media-seek-forward-symbolic-rtl.symbolic -i process-working-symbolic.svg python\lib\ptxprint\ptxprint.glade AdwaitaIcons.txt
